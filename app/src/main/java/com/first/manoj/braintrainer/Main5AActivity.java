...
public class Main5AActivity extends AppCompatActivity implements View.OnClickListener, PopupMenu.OnMenuItemClickListener {

    private AdView banner5a;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main5a);

        banner5a= (AdView) findViewById(R.id.banner5a);
        AdRequest request=new AdRequest.Builder().build();
        banner5a.loadAd(request);
    ...
    @Override
    public void onClick(View v) {
        Intent i=new Intent(Main5AActivity.this,Main5BActivity.class);
        sound=background.getBoolean("sound",true);
