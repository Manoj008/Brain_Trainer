...
public class Main3BActivity extends AppCompatActivity implements View.OnClickListener, PopupMenu.OnMenuItemClickListener {

    Bundle bundle;
    char getType;

    private AdView banner3b;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        banner3b= (AdView) findViewById(R.id.banner3b);
        AdRequest request=new AdRequest.Builder().build();
        banner3b.loadAd(request);
    ...
    @Override
    public void onClick(View v) {
        Intent i=new Intent(this,Main3CActivity.class);
        sound=background.getBoolean("sound",true);
    ...
    public void onBackPressed() {
        if(sound)
            click.start();
        startActivity(new Intent(this,Main3AActivity.class));
    }
}
