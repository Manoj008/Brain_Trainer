...
public class Main6AActivity extends AppCompatActivity implements View.OnClickListener, PopupMenu.OnMenuItemClickListener {

    private AdView banner6a;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        banner6a= (AdView) findViewById(R.id.banner6a);
        AdRequest request=new AdRequest.Builder().build();
        banner6a.loadAd(request);
    ...
    @Override
    public void onClick(View v) {
        Intent i=new Intent(this,Main6BActivity.class);
        sound=background.getBoolean("sound",true);
